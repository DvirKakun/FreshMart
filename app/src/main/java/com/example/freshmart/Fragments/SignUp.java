...
import com.example.freshmart.Classes.CountryCodes;
...
public class SignUp extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        m_SignUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checkValidation())
                {
                    m_HostedActivity.Register(firstName, lastName, email, password, phoneNumber, m_View);
                }
            }
        });
    ...
    private void createSpinner()
    {
        ...
        ArrayAdapter adapter = new ArrayAdapter(getContext(), R.layout.spinner_dropdown_item, countryCodes);
